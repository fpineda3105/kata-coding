...
public class LongestPyramidPathTest {

    @Test
    void smallCase_shouldReturn_Success() {
        int[][] test = new int[][]{{75},
                {95, 64},
                {17, 47, 82},
                {18, 35, 87, 10},
        ...
        Assertions.assertEquals(1074, LongestPyramidPath.longestSlideDown(test));
    }

    @Test
    void bigCase_shouldReturn_Success() {
        int[][] test3 = new int[][]{
            {59},
            {73, 41},
            {52, 40,  9},
        ...
        Assertions.assertEquals(7273, LongestPyramidPath.longestSlideDown(test3));
    }
